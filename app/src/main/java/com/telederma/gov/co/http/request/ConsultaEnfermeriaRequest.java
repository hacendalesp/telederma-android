 ...
 */
public class ConsultaEnfermeriaRequest extends BaseRequest {

    @SerializedName("consultation")
    @Expose
    public Consulta consulta;

    @SerializedName("nurse_consultation")
    @Expose
    public ConsultaEnfermeria consulta_medica;


    public ConsultaEnfermeriaRequest(ConsultaEnfermeria consulta_medica, Consulta consulta, String user_token, String user_email) {
