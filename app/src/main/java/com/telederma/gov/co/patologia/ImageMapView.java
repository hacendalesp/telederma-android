...
public class ImageMapView extends View {
    ...
    protected final Paint debugPaint = null;

    /**
     * ImageMapView extending android.view.View
     *
     * @param context android contexto
    ...
    public ImageMapView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            backImage = BitmapUtils.resAsBitmap(src_resource, ContextCompat.getDrawable(context, src_resource));
        } catch (Exception e) {
